        ...
        <section className="bg-gradient-to-r from-[#f5f5f5] to-[#e8edd2] p-6 rounded shadow-formShadow w-full max-w-md md:max-w-lg lg:max-w-xl mx-auto">
            ...
            <form className="space-y-2">
                <div>
                    ...
                    <input type="text" className="border border-bgLine focus:border-borderInput focus:outline-none p-2 w-full" placeholder="Unique username (e.g. jan123)" />
                </div>
                <div>
                    <label className="block">Email</label>
                    <input type="email" className="border border-bgLine focus:border-borderInput focus:outline-none p-2 w-full" />
                </div>
                <div>
                    <label className="block">Password</label>
                    <input type="password" className="border border-bgLine focus:border-borderInput focus:outline-none p-2 w-full" />
                </div>
                <div>
